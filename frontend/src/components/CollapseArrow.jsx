...
// section away: `collapsedGlyph` when collapsed (a + by default) and
// `openGlyph` when open (a left-pointing ◀ by default, or e.g. a ▼ where
// "open" should read as down). `size`/`fontSize` scale the box and glyph.
// `dark` flips it to the light-on-translucent variant used on a dark bar
// (the Notenübersicht year frame).
//
